...
gawk '{print ($2+$7)/2,($3+$8)/2}'<$basefolder/output/4dtest201_geometry.txt | head -n $ntraces | a2b > $basefolder/output/cmploc.bin
a2b < $basefolder/output/4dtest201_coords_rcv.txt n1=2 > $basefolder/output/rcvloc.bin
a2b < $basefolder/output/4dtest201_coords_src.txt n1=2 > $basefolder/output/srcloc.bin
...
cat $basefolder/output/cmploc.bin $basefolder/output/srcloc.bin $basefolder/output/rcvloc.bin |
    ...
    x2beg=3390000 x2end=3391000 x1beg=698500 x1end=710000 \
