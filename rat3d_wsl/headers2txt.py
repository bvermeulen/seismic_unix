...
basefolder = Path("/home/bvermeulen/Python/seismic_unix/rat3d/data/output")
input_filename = basefolder / "202505_geometry.txt"
filename_src = basefolder / "202505_coords_src.txt"
filename_rcv = basefolder / "202505_coords_rcv.txt"
...
for numbers in output_lines:
    ...
    rcv = (float(numbers[5]), float(numbers[6]))
    src_set.add(src)
    rcv_set.add(rcv)
