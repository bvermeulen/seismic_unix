...
sugain \
	...
	wagc=0.5 |
sustack |
suwind key=cdp min=1000 max=1280 > $basefolder/$outputfile

suximage < $basefolder/$outputfile verbose=0 f2=1000 d2=1.0 wbox=1400 hbox=700 title="Brute stack V0" cmap=grey clip=0.4
