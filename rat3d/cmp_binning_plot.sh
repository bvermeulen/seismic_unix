...
do
	...
	sucdpbin < $basefolder/line1h.su \
		  xline=717544,718719 \
		  yline=3371452,3370694 \
          verbose=1 dcdp=$dcdp distmax=$distmax 2>$basefolder/cdp.log |
	suwind key=cdp min=1001 tmax=2.5 > $basefolder/line1cdp$distmax.su
	susort < $basefolder/line1cdp$distmax.su cdp offset > $basefolder/line1cdp_sorted$distmax.su

	echo Creating chart data
	suchart < $basefolder/line1cdp$distmax.su key1=cdp key2=offset > $basefolder/plotdata outpar=par
...
rm plot*.ps
#rm line1cdp*.su
gv $basefolder/crookedLine_binning.ps
