...
suximage < $basefolder/$1.clean key=offset perc=98 cmap=grey \
...
# suwind < $basefolder/$1.clean > $basefolder/$1.tmp
...
suximage < $basefolder/$1.filtered key=offset perc=98 cmap=grey \
